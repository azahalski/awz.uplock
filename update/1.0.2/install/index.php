...
class awz_uplock extends CModule
{
	var $MODULE_ID = "awz.uplock";
	var $MODULE_VERSION;
    ...
    public function __construct()
	{
        ...
        $this->MODULE_NAME = Loc::getMessage("AWZ_UPLOCK_MODULE_NAME");
        $this->MODULE_DESCRIPTION = Loc::getMessage("AWZ_UPLOCK_MODULE_DESCRIPTION");
    ...
    function DoInstall()
    {
        ...
        $APPLICATION->IncludeAdminFile(
            Loc::getMessage("AWZ_UPLOCK_MODULE_NAME"),
    ...
    function DoUninstall()
    {
        ...
        if($step < 2) {
            $APPLICATION->IncludeAdminFile(
                Loc::getMessage('AWZ_UPLOCK_INSTALL_TITLE'),
    ...
    function InstallEvents()
    {
        ...
        $eventManager->registerEventHandlerCompatible(
            ...
            $this->MODULE_ID, '\\Awz\\Uplock\\Access\\Handlers', 'OnAfterUserUpdate'
        );
        $eventManager->registerEventHandlerCompatible(
            'main', 'OnAfterUserAdd',
            $this->MODULE_ID, '\\Awz\\Uplock\\Access\\Handlers', 'OnAfterUserUpdate'
        ...
        $eventManager->registerEventHandlerCompatible(
            'main', 'OnPageStart',
            $this->MODULE_ID, '\\Awz\\Uplock\\Handlers', 'OnPageStart'
        );
        return true;
    }
    ...
    function InstallFiles()
    {
        CopyDirFiles(
            ...
            $_SERVER['DOCUMENT_ROOT']."/bitrix/components/awz",
            true, true
        );
        return true;
    }
    ...
    {
        DeleteDirFilesEx("/bitrix/components/awz/uplock.config.permissions");
        return true;
    }
